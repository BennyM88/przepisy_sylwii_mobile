...
import 'package:przepisy_sylwii_mobile/core/register_cubit/register_cubit.dart'
    as _i8;
import 'package:przepisy_sylwii_mobile/core/user_cubit/user_cubit.dart' as _i12;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.singleton<_i9.CategoryCubit>(_i9.CategoryCubit(gh<_i7.RecipeCubit>()));
    gh.singleton<_i10.ChangePswdCubit>(
        _i10.ChangePswdCubit(gh<_i3.FirebaseAuthRepository>()));
    gh.singleton<_i11.FavoritesCubit>(_i11.FavoritesCubit(
      gh<_i4.FirebaseRepository>(),
      gh<_i3.FirebaseAuthRepository>(),
    ));
    gh.singleton<_i12.UserCubit>(_i12.UserCubit(
      gh<_i3.FirebaseAuthRepository>(),
      gh<_i7.RecipeCubit>(),
      gh<_i11.FavoritesCubit>(),
    ));
    gh.singleton<_i13.DeleteAccCubit>(_i13.DeleteAccCubit(
      gh<_i3.FirebaseAuthRepository>(),
      gh<_i12.UserCubit>(),
    ));
    return this;
